...
def msseg2_train_transform(
    ...
    train_transform = [
        ...
        transforms.RandBiasFieldd(
            "image", prob=0.15, degree=3, coeff_range=(0.0, 0.1)
        ),
...
def msseg2_test_transform():
    return msseg2_val_transform()


def msseg2_vis_transform(spacing=(1.0, 1.0, 1.0)):
    vis_transform = [
        ReadImaged(["image", "label"], allow_missing_keys=True),
        transforms.AddChanneld("label", allow_missing_keys=True),
...
class MSSEG2DataModule(LightningDataModule):
    def __init__(
        self,
        data_properties,
        spacing=(1.0, 1.0, 1.0),
        ...
        **kwargs,
        ...
        self.train_transform = msseg2_train_transform(
            spacing, spatial_size, num_patches
        )
        self.val_transform = msseg2_val_transform()
        self.test_transform = msseg2_test_transform()
        self.vis_transform = msseg2_vis_transform(spacing)
